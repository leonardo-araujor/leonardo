        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" >
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800" style="text-align: center; margin: 50px;">Cadastrar Cupom</h1>
            ...
            <div class="card-body p-0">
                ...
                <div class="row" style="align-items: center; justify-content: center; text-align: center;">
                    <div class="col-lg-7" >
                        <div class="p-5"  >
                            <form class="user" action="inserirCupom.php" method="POST">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" name="codigo" class="form-control form-control-user" id="codigo"
                                            placeholder="Código do cupom">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" name="desconto" class="form-control form-control-user" id="desconto"
