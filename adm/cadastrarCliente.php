        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" >
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800" style="text-align: center; margin: 50px;">Cadastrar Serviço</h1>
            ...
            <div class="card-body p-0">
                ...
                <div class="row" style="align-items: center; justify-content: center; text-align: center;">
                    <div class="col-lg-7" >
                        <div class="p-5"  >
                            <form class="user" action="inserirCliente.php" method="POST">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="number" name="telefone" class="form-control form-control-user" id="telefone"
                                            placeholder="Telefone do cliente">
                                    </div>
                                </div>
                                <div class="form-group">
        <textarea name="email" class="form-control form-control-user" id="email"
            placeholder="Descreva o serviço" style="resize: vertical; border-radius: 20px;"></textarea>
    </div>
